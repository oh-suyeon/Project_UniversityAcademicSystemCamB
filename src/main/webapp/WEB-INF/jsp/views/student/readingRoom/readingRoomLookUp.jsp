		...
		<div class="card shadow">
			...
			<div class="card-body table-responsive p-0">
				<table id="myInform" style="font-size:16px; margin: 20px 0px 20px 50px;">
					<tr>
						<th style="width: 120px;">열람실명 :</th><td id="roomName" class="tdWhite" style="width: 120px;">-</td>
						<th style="width: 250px;">좌석명 :</th><td id="seatNum" class="tdWhite" style="text-align: left; width: 170px;">-</td>
						<th style="width: 120px;">시작시간 :</th><td id="startTime" class="tdWhite" style="text-align: left; width: 180px;">-</td>
						<th style="width: 120px;">종료시간 :</th><td class="tdWhite">-</td>
						<td class="tdWhite"><input type="hidden" id="seatReservNum"> 
