					...
					<tbody class="alignTB">
						<tr>
							...
							<td id="gradEvalResult">
								<label class='badge badge-danger' id="test">졸업 불가</label>
							</td>
...
<script>
	...
	$(function() {
		...
		tableHtml = tableHtml.replaceAll("</tr></td><td class='tdWhite'><tr>" , "</tr><tr>");
	...
	function fn_grad() {
		Swal.fire({
			  title: '졸업을 축하합니다! ',
			  text: '모두 8개월 동안 고생 많으셨어요! 앞으로도 건강하시고 좋은 일만 있길 바랍니다!',
			  height: 800,
			  width: 800,
			  padding: '3em',
			  showCloseButton: true,
			  confirmButtonText:
				    '<i class="fa fa-thumbs-up"></i> 안녕!',
			  background: '#fff url(/resources/img/event/back.jpg)',
			  showClass: {
			  ...
			  backdrop: `
			    rgba(107, 33, 181 ,0.4)
			    url("/resources/img/event/test4.gif")
			    left top
			    no-repeat
			  `
			}).then((result) => {
