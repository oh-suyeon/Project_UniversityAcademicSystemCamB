				...
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="width: 99%">
					<div class="row">
						...
						<form method="get" action="/professor/study/list" name="frmSearch" id="frmSearch">
							...
							<!-- 게시글 수  -->
							<span style="color: black; font-weight: bold; float: left; margin-top: 3%;">총 <span style="color: #C02B55"><fmt:formatNumber value="${totalCount}" pattern="#,###" /></span>건의 게시물이 있습니다.</span>
