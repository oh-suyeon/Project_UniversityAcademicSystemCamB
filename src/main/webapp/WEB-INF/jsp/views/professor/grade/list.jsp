			...
			<div class="table-responsive">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="width: 99%">
					<div class="row">
						...
						<span style="color: black; font-weight: bold; float: left; margin-top: 3%;">총 <span style="color: #C02B55"><fmt:formatNumber value="${paginationInfo.totalRecordCount}" pattern="#,###" /></span>건의 게시물이 있습니다.</span>
						<span style="color: black; font-weight: bold; float: left; margin-top: 3%;">[미입력 <span style="color: #C02B55"><fmt:formatNumber value="${gradeCount}" pattern="#,###" /></span>건]</span>
