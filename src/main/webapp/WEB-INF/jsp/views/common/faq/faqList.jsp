...
<body>
		...
		<div class="card-body">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="width: 100%">
                   ...
                   >checked==true</c:if>>분류</option> --%>
							<div class="faq-tab" style="margin-left: 60px;">
								<table id="table1" cellspacing="0" cellpadding="0"  style="text-align: center; border-collapse:separate; border-radius: 15px;">
									<tr>
					...
					<div style="width: 40%; height: 100px; padding-left:70px;  position: relative; top:50px; left:1015px;">
					...
					<div class="row">
						<div class="col-sm-12">
							<span
								style="color: black; position: relative; left: 50px; bottom:15px; font-weight: bold;">총<span
							...
							<table class="table" id="dataTable" cellspacing="0" role="grid"
								aria-describedby="dataTable_info" style="width: 93%; position: relative; left: 50px; bottom: 10px;">
								<thead>
									<tr role="row">
	...
	<script type="text/javascript">
			...
			$(function() {
				...
				$("#faqKwdCode" + faqKwdCode).css("background", "#a9bec3").css("color", "white").css("font-weight", "bold");
