			...
			<div class="row">
				...
				<div class="col-sm-8">
					<table>
						<tr> 
							<th class="td1">아이디</th>
							<td style="background-color: white;">${memberVo.memId}</td>
						</tr>
						<tr> 
							<th class="td1">이름</th>
							<td style="background-color: white;">${memberVo.name}</td>
						</tr>
						<tr> 
							<th class="td1">전화번호</th>
							<td style="background-color: white;">${memberVo.phNum}</td>
						</tr>
						<tr> 
							<th class="td1">이메일</th>
							<td style="background-color: white;">${memberVo.email}</td>
						</tr>
						<tr> 
						...
						<tr> 
							<th class="td1">주소</th>
							<td style="background-color: white;">${memberVo.addr}
						</tr>
						<tr> 
							<th class="td1">상세 주소</th>
							<td style="background-color: white;">${memberVo.addrDetail}</td>
						</tr>
						<tr> 
							<th class="td1">은행 명</th>
							<td style="background-color: white;">${memberVo.bankCode}</td>
						</tr>
						<tr> 
							<th class="td1">계좌 번호</th>
							<td style="background-color: white;">${memberVo.bankAccntNum}</td>
						</tr>
						<tr> 
							<th class="td1">비밀번호 변경일</th>
							<td style="background-color: white;">${memberVo.modDateDisplay}<c:if test="${memberVo.modDateDisplay == null}">-</c:if></td>
						</tr>
					</table>
					<div>
