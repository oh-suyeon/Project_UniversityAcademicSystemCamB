	                               			...
	                               			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
		                                        <div class="col mr-2">
		                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
		                                            	<label class="badge <c:if test='${jobCountVo.takeOffCnt01 != 0}'>badge-warning</c:if><c:if test='${jobCountVo.takeOffCnt01 == 0}'>badge-light</c:if>" style="cursor: pointer;" onclick="location.href='/student/takeOff/takeOffApplyList'">
		                                            		<span class="text-gray-800">휴학</span> ${jobCountVo.takeOffCnt01}/${jobCountVo.takeOffCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge <c:if test='${jobCountVo.returnCnt01 != 0}'>badge-warning</c:if><c:if test='${jobCountVo.returnCnt01 == 0}'>badge-light</c:if>" style="cursor: pointer;" onclick="location.href='/student/return/returnApplyList'">
		                                            		<span class="text-gray-800">복학</span> ${jobCountVo.returnCnt01}/${jobCountVo.returnCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge <c:if test='${jobCountVo.readmissionCnt01 != 0}'>badge-warning</c:if><c:if test='${jobCountVo.readmissionCnt01 == 0}'>badge-light</c:if>" style="cursor: pointer;" onclick="location.href='/student/readmission/readmApplyList'">
		                                            		<span class="text-gray-800">재입학</span> ${jobCountVo.readmissionCnt01}/${jobCountVo.readmissionCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge <c:if test='${jobCountVo.expulsionCnt01 != 0}'>badge-warning</c:if><c:if test='${jobCountVo.expulsionCnt01 == 0}'>badge-light</c:if>" style="cursor: pointer;" onclick="location.href='/student/expulsion/expulsionApplyList'">
		                                            		<span class="text-gray-800">퇴학</span> ${jobCountVo.expulsionCnt01}/${jobCountVo.expulsionCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge <c:if test='${jobCountVo.courseChangeCnt01 != 0}'>badge-warning</c:if><c:if test='${jobCountVo.courseChangeCnt01 == 0}'>badge-light</c:if>" style="cursor: pointer;" onclick="location.href='/student/courseChange/courseChangeApplyList'">
	                                        ...
	                                        <div class="col mr-2">
	                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
				                           			...
				                           			<c:if test="${volunteerVo.volRecogTimeSumTotal - volunteerVo.volRecogTimeSum > 0}">
					                           			<br/><a style="font-size: 0.8em;" href="/student/volunteer/volunteerList"><label class="text-warning" style="cursor: pointer; font-size: 0.8em;">${volunteerVo.volRecogTimeSumTotal - volunteerVo.volRecogTimeSum}</label></a> 
					                           			<span style="font-size: 0.8em;">시간의 봉사 내역이 승인 대기 중입니다.</span>
				                           			</c:if>
			                           			</div>
	                                        </div>
	                                        <div class="col-auto">
