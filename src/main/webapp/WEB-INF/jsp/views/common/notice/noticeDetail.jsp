	...
	<div class="card shadow mb-4" style="width: 100%;">
		...
		<table class="table" id="dataTable" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
								<tr>
									...
									<td id="title" colspan="3" class="tdWhite">${nv.title}</td>
								</tr>
								<tr role="row">
									...
									<td id="memId" style="width: 40%" class="tdWhite">${nv.name} - (${nv.empId})</td>
									...
									<td class="tdWhite" id="modDate"><fmt:formatDate pattern="yyyy-MM-dd" value="${nv.modDate}"/></td>
								</tr>
								<tr class="even">
									<td colspan="4" id="content" class="tdWhite" style="height: 380px">${nv.content}<br>
